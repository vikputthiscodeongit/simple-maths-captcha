...
| `ntp`<br> **Required**                                                       | [@codebundlesbyvik/ntp-sync instance](https://github.com/vikputthiscodeongit/ntp-sync?tab=readme-ov-file).                                                                                | -                        | `ntp-sync` instance.                                                                                                                                                                                                                                                                 |
...
| `labelElLoadingTextContent`                                                  | `string`                                                                                                                                                                                  | `"Loading CAPTCHA"`      | Text shown as `<label>` content when loading.                                                                                                                                                                                                                                        |
