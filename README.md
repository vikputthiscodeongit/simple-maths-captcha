...
| **! REQUIRED !** `generatorEndpointUrl` | `string`                                                                                                                                | -                      | URL of the problem generator endpoint. Should return an **array** with a **length of 3**, the **first 2 items** being the **digits that compose the maths problem** and the **final item** being a **Unix timestamp in milliseconds after which the problem is invalidated**. |
